...
const Profile = () => {
  return (
   <>
   <div className="w-full h-[100px] bg-black rounded-xl flex ">
  ...
  <AvatarFallback>CN</AvatarFallback>
               ...
               <div className="h-full w-[40%] pl-2  flex flex-col">
                ...
                <p className="text-xl ml-1 text-white">Abhinav Gupta</p>
                
                </div>  
                
                <div className="w-full h-[50%] flex  items-center  ">
                <p className="text-xl  text-yellow-500">Year :</p>
                <p className="text-xl ml-1 text-white">2026</p>
                </div>
               </div>
               <div className="h-full w-[40%] pl-2  ">
               <div className="w-full flex  items-center  h-[50%] ">
                <p className="text-xl text-yellow-500">Gender :</p>
                <p className="text-xl ml-1 text-white">Male</p>
                </div>  
                
                <div className="w-full h-[50%] flex  items-center  ">
                <p className="text-xl  text-yellow-500 ">Skills :</p>
                <p className="text-xl ml-1 text-white">React</p>
                </div>
               </div>
