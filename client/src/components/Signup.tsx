  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-black">
      <div className="flex w-full max-w-7xl">
        ...
        <div className="w-full md:w-1/2 p-10 bg-gray-100 rounded-md border-gray-300">
          <div className="text-center">
            <h1 className="text-4xl md:text-7xl font-bold text-yellow-600">
              WELCOME<br />
              <span className="text-2xl md:text-3xl text-black">TO CODECAP COMMUNITY</span>
            </h1>
          </div>
          <form onSubmit={handleSubmit} className="mt-10 flex flex-col justify-center">
            ...
            <p className="mt-4 text-lg text-center text-gray-400">
              Already registered?{' '}
              <a href="/login" className="text-blue-500 bg-white p-2 rounded-xl border border-gray-500 focus:underline">
                Login
              </a>
            </p>
          </form>
        ...
        <div className="flex items-center justify-center w-full md:w-1/2 bg-black text-white text-center">
          <div className="flex flex-col items-center justify-center gap-4 p-4 md:p-0">
            <img className="w-1/2" src="hat.jpg" alt="Hat" />
            <h2 className="text-4xl md:text-7xl font-bold">
              BOOST YOUR <span className="text-yellow-500">HACKATHON JOURNEY</span>
            </h2>
            <img className="w-full md:w-auto" src="Vector(2).png" alt="Vector" />
          </div>
        </div>
      </div>
    </div>
