    ...
    <div className="text-center text-white p-6 md:p-10 bg-black">
      ...
      <div className="flex flex-col md:flex-row justify-center space-y-6 md:space-y-0 md:space-x-8">
        <div className="border-2 border-yellow-400 p-4 w-full md:w-[600px] bg-gray-900">
          ...
          <button className="bg-black text-xl text-white border-2 border-white px-4 py-2 hover:bg-yellow-400 hover:text-black hover:font-bold">
            Check In
          </button>
        </div>
        <div className="border-2 border-yellow-400 p-4 w-full md:w-[600px] bg-gray-900">
          ...
          <button className="bg-black text-white border-2 border-white px-4 py-2 hover:bg-yellow-400 text-xl hover:font-bold hover:text-black">
            Get Started
          </button>
        </div>
      </div>
