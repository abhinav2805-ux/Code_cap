    ...
    <div className="text-center text-white p-10 bg-black">
      ...
      <div className="flex justify-center space-x-8">
        <div className="border-2 border-yellow-400 p-4 w-[600px] bg-gray-900">
          ...
          <button className="bg-black text-white border-2 border-white px-4 py-2 hover:bg-yellow-400 hover:text-black">Check In</button>
        </div>
        <div className="border-2 border-yellow-400 p-4 w-[600px] bg-gray-900">
          ...
          <button className="bg-black text-white border-2 border-white px-4 py-2 hover:bg-yellow-400 hover:text-black">Get Started</button>
        </div>
      </div>
    </div>
  );
